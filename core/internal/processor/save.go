...
func save(ch chan *dtoModel.PictureRaw, wg *sync.WaitGroup) {
...
func savePicture(picture *dtoModel.PictureRaw, wg *sync.WaitGroup) {
	defer wg.Done()
...
func savePictureLocal(picture *dtoModel.PictureRaw) {
...
func savePictureWebdav(picture *dtoModel.PictureRaw) {
