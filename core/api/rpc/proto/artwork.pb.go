...
type SendMessageProcessedArtworkRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SendMessageProcessedArtworkRequest) Reset() {
	*x = SendMessageProcessedArtworkRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *SendMessageProcessedArtworkRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendMessageProcessedArtworkRequest) ProtoMessage() {}

func (x *SendMessageProcessedArtworkRequest) ProtoReflect() protoreflect.Message {
	mi := &file_artwork_proto_msgTypes[5]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendMessageProcessedArtworkRequest.ProtoReflect.Descriptor instead.
func (*SendMessageProcessedArtworkRequest) Descriptor() ([]byte, []int) {
	return file_artwork_proto_rawDescGZIP(), []int{5}
}

func (x *SendMessageProcessedArtworkRequest) GetArtworkID() uint64 {
	if x != nil {
		return x.ArtworkID
	}
	return 0
...
type SendMessageProcessedArtworkResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SendMessageProcessedArtworkResponse) Reset() {
	*x = SendMessageProcessedArtworkResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_artwork_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SendMessageProcessedArtworkResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SendMessageProcessedArtworkResponse) ProtoMessage() {}

func (x *SendMessageProcessedArtworkResponse) ProtoReflect() protoreflect.Message {
	mi := &file_artwork_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SendMessageProcessedArtworkResponse.ProtoReflect.Descriptor instead.
func (*SendMessageProcessedArtworkResponse) Descriptor() ([]byte, []int) {
	return file_artwork_proto_rawDescGZIP(), []int{6}
}

func (x *SendMessageProcessedArtworkResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
func (x *ProcessedArtworkInfo_PictureInfo) Reset() {
	*x = ProcessedArtworkInfo_PictureInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_artwork_proto_msgTypes[7]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
var file_artwork_proto_rawDesc = []byte{
	...
	,
...
var file_artwork_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_artwork_proto_goTypes = []interface{}{
	...
	(*SendMessageProcessedArtworkRequest)(nil),  // 6: artwork.SendMessageProcessedArtworkRequest
	(*SendMessageProcessedArtworkResponse)(nil), // 7: artwork.SendMessageProcessedArtworkResponse
	(*ProcessedArtworkInfo_PictureInfo)(nil),    // 8: artwork.ProcessedArtworkInfo.PictureInfo
}
var file_artwork_proto_depIdxs = []int32{
	...
	8, // 1: artwork.ProcessedArtworkInfo.pictures:type_name -> artwork.ProcessedArtworkInfo.PictureInfo
	...
	6, // 5: artwork.ArtworkService.SendMessageProcessedArtwork:input_type -> artwork.SendMessageProcessedArtworkRequest
	3, // 6: artwork.ArtworkService.GetArtworkInfo:output_type -> artwork.GetArtworkResponse
	5, // 7: artwork.ArtworkService.GetPictureData:output_type -> artwork.GetPictureDataResponse
	7, // 8: artwork.ArtworkService.SendMessageProcessedArtwork:output_type -> artwork.SendMessageProcessedArtworkResponse
...
func file_artwork_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_artwork_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SendMessageProcessedArtworkRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_artwork_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SendMessageProcessedArtworkResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_artwork_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
